...
unsigned char	 ir_status , ir_timer , Counter ,Set=1, mode ,re , repeat , Counter_On_set=40 , Counter_On=40,s,m,h,CountINT ,RGB , timer , one , modetime,Rq,Gq,Bq;
...
void POWER_INITIAL (void) 
{
	...
	PORTA  = 0B00000001;					
	TRISA  = 0B00001100;				//PA输入输出 0-输出 1-输入
                                        //PA2-IN PA4-OUT
