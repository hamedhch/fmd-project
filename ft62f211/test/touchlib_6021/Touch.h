...
#define   IO_TOUCH_ATTR	                     0x0004	     //定义所使用的按键Bit 0~3对应key1~key4，0不使用，1使用	
#define   TouchCount                                 1               	  //按键数
...
#define  KEY2_ACTIVE_SENSOR_DELTA1		32*KEY2_ON/100
...
#define  KEY2_INACTIVE_SENSOR_DELTA1		32*KEY2_OFF/100
