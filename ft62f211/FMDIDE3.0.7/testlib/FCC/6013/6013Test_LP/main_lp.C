...
void SYS_INITIAL (void) 
{
	...
	TRISA = 0B11111111;		// 0-输出 1-输入   PA2(TKCAP) set input
    TRISB = 0B11111111;		// B2-B7  TK7-TK2
    TRISC = 0B11111111;     // C0-C1  TK1-TK0
   ...
   while (1)
    {
        ...
        DelayUs(5000);
        DelayUs(5000); //20220401 延时30ms上传给上位机
        DelayUs(5000); //20220407 延时30ms上传给上位机
