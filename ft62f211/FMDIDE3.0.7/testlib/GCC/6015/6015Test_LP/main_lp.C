...
void SYS_INITIAL (void) 
{
	...
	OSCCON = SYS_OSCCON;    //WDT 32KHZ IRCF=110=16MHZ/4=4MHZ,0.25US/T
							//Bit0=1,系统时钟为内部振荡器
	...
	TRISA = 0B11111111;	// 0-输出 1-输入        RA4 -
    	TRISB = 0B11111111;	// B4-B7  TK5-TK2    PB7--touch
   	TRISC = 0B11111111;
	TRISD = 0B11111111;	// TKCAP PD5
...
void main(void )
{
    ...
    while (1)
    {
        ...
        DelayUs(5000);
        DelayUs(5000); //20220401 延时加长上传给上位机
        DelayUs(5000); //20220407 延时加长上传给上位机
