...
volatile unsigned char Data[3],Time=0 ,DataM[3],DataS[4][3],RFData[3], contlern=0;
volatile unsigned char Start=0,Count=0,Buffer=0,Bit=0, key=0  ;	
  ...
  if(T0IE && T0IF)					
	{
        ...
        if(data_touch==1 && conterout > 360 && conterout<850 ){
			...
			if(conterout>690 && conterout<725){
                ...
                SEND_CODE(DataS[2][0],DataS[2][1],DataS[2][2]);
                SEND_CODE(DataS[2][0],DataS[2][1],DataS[2][2]);
                SEND_CODE(DataS[2][0],DataS[2][1],DataS[2][2]);
                SEND_CODE(DataS[2][0],DataS[2][1],DataS[2][2]);
                SEND_CODE(DataS[2][0],DataS[2][1],DataS[2][2]);
			...
			if(conterout>820 && conterout<850){
                ...
                SEND_CODE(DataS[3][0],DataS[3][1],DataS[3][2]);
                SEND_CODE(DataS[3][0],DataS[3][1],DataS[3][2]);
                SEND_CODE(DataS[3][0],DataS[3][1],DataS[3][2]);
                SEND_CODE(DataS[3][0],DataS[3][1],DataS[3][2]);
                SEND_CODE(DataS[3][0],DataS[3][1],DataS[3][2]);
        ...
        if(data_touch==1 && conterout > 1210 && conterout<2100 ){
			...
			if(conterout>1780 && conterout<1830){
				key=7;
			}
			if(conterout>1900 && conterout<1950){
				key=8;
			}
