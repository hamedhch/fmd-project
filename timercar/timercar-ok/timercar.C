...
*  VDD-----------|1(VDD)    (GND)8|------------GND     
*  OUT-----------|2(PA2)    (PA4)7|------------ACC
*  LED-----------|3(PA1)    (PA5)6|------------door
*  lamp----------|4(PA3)    (PA0)5|------------ghofl
*			      ----------------
*/
//*********************************************************
#include "SYSCFG.h"
...
volatile unsigned char S=0,M=0,H=0, mode=0 ,Lock=1,Lock2=1 , Door_Lock=0, Ghofl_Lock=0, Lamp_Lock=0 , ACC_Lock=0;
...
void POWER_INITIAL (void) 
{
	...
	PORTA  = 0B00111001;					
	TRISA  = 0B00111001;				//PA输入输出 0-输出 1-输入
                                        //PA2-IN PA4-OUT
	WPUA   = 0B00111001;     			//PA端口上拉控制 1-开上拉 0-关上拉								
					 		            //开PA2上拉
	MSCKCON = 0B00000000;
}
...
//            }
        ...
        if(lamp==0 && mode==0)mode=1;
        
        if(lamp==1 && Lamp_Lock==0  && mode==1 ){
