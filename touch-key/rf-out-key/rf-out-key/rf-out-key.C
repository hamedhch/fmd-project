  ...
  if(T0IE && T0IF)					
	{
        ...
        if(data_touch!=0 && conteroutnot<=110){
             conteroutnot++;
        }
        
        
        if(data_touch==1 && conterout>5 && conterout<15 ){
			conterout++;
        }
        ...
        if(conteroutnot>10 ){
            ...
            if(conterout>53 && conterout<57 ){

                 
                if(lastKey==1)conterout=20;
                if(lastKey==2)conterout=27;
                if(lastKey==3)conterout=34;
                if(lastKey==4)conterout=41;
            ...
            if(((conterout>18 && conterout<22 ) || O1==1 ) && LernRFKey!=1){
            ...
            if(((conterout>25 && conterout<29 ) || O2==1) && LernRFKey!=2){
            ...
            if(((conterout>32 && conterout<36 ) || O3==1) && LernRFKey!=3){
            ...
            if(((conterout>39 && conterout<43 ) || O4==1) && LernRFKey!=4){
